...
class DropzoneArea extends Component {
          ...
          _this.setState(
            {
              fileObjects:
                this.props.filesLimit <= 1
                  ...
                  : _this.state.fileObjects.concat({ file: file, data: event.target.result }),
            },
            () => {
  ...
  handleDropRejected(rejectedFiles, evt) {
    ...
    rejectedFiles.forEach((rejectedFile) => {
      message = this.props.getDropRejectMessage(rejectedFile, this.props.acceptedFiles, this.props.maxFileSize);
    });
        ...
        >
          <div className={classes.dropzoneTextStyle}>
            <Typography
              ...
              variant="h5"
              className={this.props.dropzoneParagraphClass}
            >
