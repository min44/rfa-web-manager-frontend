...
export const ParameterManagementPage: React.FC = observer((props: any) => {
  ...
  const Boards = (props: any) => {
    return props.parametersJsonFiles.length > 0 ? (
      props.parametersJsonFiles.map((parametersJsonFile: any, index: number) => (
  ...
  const Cards = (props: any) => {
    return props.parametersJsonFile.length > 0 ? (
      props.parametersJsonFile.map((parameter: any, index: number) => (
